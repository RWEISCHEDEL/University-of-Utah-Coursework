...
public class MainActivity extends AppCompatActivity implements KnobView.OnAngleChangedListener, Button.OnClickListener, PaintSplotch.OnSplotchChangedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _paintView = new PaintArea(this);
        rootLayout.addView(_paintView, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, 2));
    ...
    public void onAngleChanged(float angle, String name){
        float volume = angle;
    ...
    public void onSplotchChanged(int name) {
        for(PaintSplotch splotch : _splotchList){
            if(splotch._name != name){
                ...
                _paintView.setLineColor(splotch.get_splotchColor());
            }
        }
    }
}
