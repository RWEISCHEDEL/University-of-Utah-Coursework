...
public class CSVToXMLConverterActivity extends AppCompatActivity implements Button.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mainView.append("CSV To XML Converter");
    ...
    public void onClick(View view) {
        if(view.getTag().toString().equals("convert")){
            ...
            if(!createCSVFile()){
                output.setText("The CSV entered is not in a valid format.");
                return;
            }
            ...
            try {
                ...
                Element rootElement = newDocument.createElement("XML");
                newDocument.appendChild(rootElement);

                Log.i("onclick", "before reader");
                FileReader fileReader = new FileReader(new File(getFilesDir(), "convert-input-xml.csv"));
                ...
                try {
                    ...
                    writer = new FileWriter(new File(getFilesDir(), "convert-output-xml.xml"));
            ...
            builder.setMessage("Enter the CSV string you wish to convert to XML beneath the Input label, and then " +
    ...
    public boolean createCSVFile(){
        ...
        try {
            ...
            File file = new File("convert-input-xml.csv");
            if(file.exists()){
                file.delete();
            }
            Log.i("createFile", "after");

            OutputStreamWriter outputStreamWriter = new OutputStreamWriter(this.openFileOutput("convert-input-xml.csv", Context.MODE_PRIVATE));
            for(String s : lines){
    ...
    public void convertXMLFileToXMLSTring(){
        String answer = "";

        try {
            InputStream inputStream = this.openFileInput("convert-output-xml.xml");
            ...
            output.setText("Cannot find XML file");
            return;
        } catch (IOException e) {
            Log.e("login activity", "Can not read file: " + e.toString());
            output.setText("There was a issue reading the XML file.");
            return;
        }
