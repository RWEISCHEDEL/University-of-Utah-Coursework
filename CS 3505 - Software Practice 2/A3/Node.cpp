...
/*This method serves as the desconstructor for the Node class, it llops through all the values in the pointer array and deletes the reference and sets it back to null. It recusively calls this method to ensure all pointers are deleted from this node and all its pointer nodes nodes.*/
